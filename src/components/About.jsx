...
import { Users, Target, Award, Globe, BookOpen, Video, ArrowRight, CheckCircle } from 'lucide-react';
...
const About = () => {
  return (
    <div className="font-sans text-slate-600 bg-white">
      ...
      {/* --- HERO SECTION --- */}
      {/* Changed to White Background, Reduced Padding and Text Size */}
      <section className="pt-12 pb-16 relative overflow-hidden">
        <div className="max-w-5xl mx-auto px-6 relative z-10 grid md:grid-cols-2 gap-10 items-center">
          
          <div className="space-y-5 order-2 md:order-1">
            <span className="text-teal-500 font-bold tracking-wider uppercase text-xs">About Us</span>
            <h1 className="text-3xl md:text-4xl font-bold text-slate-800 leading-tight">
              Forging the future of <span className="text-teal-500">Education</span>.
            </h1>
            <p className="text-slate-500 text-base leading-relaxed max-w-md">
              We are on a mission to democratize learning. Whether you are a student looking for skills or a teacher looking to share knowledge, we bridge the gap.
            </p>
          ...
          <div className="relative order-1 md:order-2">
             ...
             <div className="absolute -bottom-4 -left-4 bg-white p-3 rounded-lg shadow-lg border border-gray-100 flex items-center gap-3">
                ...
                <div>
                   <p className="text-[10px] text-gray-400 font-bold uppercase">Community</p>
                   <p className="text-sm font-bold text-slate-800">10k+ Learners</p>
                </div>
             </div>
          </div>
        </div>
      ...
      {/* --- STATS SECTION --- */}
      {/* Simplified, White Background, Smaller Typography */}
      <section className="py-10 border-y border-gray-50">
        <div className="max-w-5xl mx-auto px-6">
           <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
              <div className="p-2">
                 <h3 className="text-2xl font-bold text-slate-800">15K+</h3>
                 <p className="text-xs text-gray-500 font-medium uppercase tracking-wide mt-1">Active Students</p>
              </div>
              <div className="p-2 border-l border-gray-100">
                 <h3 className="text-2xl font-bold text-slate-800">1,200+</h3>
                 <p className="text-xs text-gray-500 font-medium uppercase tracking-wide mt-1">Expert Mentors</p>
              </div>
              <div className="p-2 border-l border-gray-100">
                 <h3 className="text-2xl font-bold text-slate-800">850+</h3>
                 <p className="text-xs text-gray-500 font-medium uppercase tracking-wide mt-1">Courses</p>
              </div>
              <div className="p-2 border-l border-gray-100">
                 <h3 className="text-2xl font-bold text-slate-800">4.9</h3>
                 <p className="text-xs text-gray-500 font-medium uppercase tracking-wide mt-1">Rating</p>
              </div>
           </div>
        </div>
      </section>
      ...
      {/* --- MISSION & VISION --- */}
      {/* Reduced vertical padding and image height */}
         ...
         <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
               ...
               <h2 className="text-2xl md:text-3xl font-bold text-slate-800 mb-4">
                  Providing the best <span className="text-teal-500">online learning</span> experience.
               </h2>
               <p className="text-sm text-slate-500 leading-relaxed mb-6">
                  Totc is a global online learning platform that offers anyone, anywhere access to online courses and degrees from world-class universities and companies.
               </p>
      ...
      {/* --- VALUES GRID --- */}
      {/* Changed from Dark Blue to White Background with Cards */}
      <section className="py-16 bg-white">
         <div className="max-w-5xl mx-auto px-6 text-center">
            <h2 className="text-2xl font-bold text-slate-800 mb-10">Why students choose us</h2>
            ...
            <div className="grid md:grid-cols-3 gap-6">
               ...
               <div className="bg-white border border-gray-100 p-6 rounded-xl shadow-sm hover:shadow-md transition-shadow">
                  ...
                  <h3 className="text-lg font-bold text-slate-800 mb-2">Flexible Learning</h3>
                  <p className="text-gray-500 text-sm leading-relaxed">
                     Learn at your own pace, move between multiple courses effortlessly.
                  </p>
               </div>
               ...
               <div className="bg-white border border-gray-100 p-6 rounded-xl shadow-sm hover:shadow-md transition-shadow">
                  ...
                  <h3 className="text-lg font-bold text-slate-800 mb-2">Expert Certifications</h3>
                  <p className="text-gray-500 text-sm leading-relaxed">
               ...
               <div className="bg-white border border-gray-100 p-6 rounded-xl shadow-sm hover:shadow-md transition-shadow">
                  ...
                  <h3 className="text-lg font-bold text-slate-800 mb-2">Global Community</h3>
                  <p className="text-gray-500 text-sm leading-relaxed">
                     Join millions of learners from around the world and grow together.
                  </p>
               </div>
            </div>
         </div>
      ...
      <section className="py-16 max-w-5xl mx-auto px-6 border-t border-gray-50">
         <div className="text-center mb-12">
            <span className="text-teal-500 font-bold uppercase text-xs tracking-wider">Our Team</span>
            <h2 className="text-2xl font-bold text-slate-800 mt-2">Meet the minds behind Totc</h2>
         </div>

         <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {[
               { name: "John Doe", role: "CEO & Founder", img: "https://images.unsplash.com/photo-1560250097-0b93528c311a?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80" },
               { name: "Jane Smith", role: "Head of Content", img: "https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80" },
               { name: "Mike Johnson", role: "Lead Developer", img: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80" },
               { name: "Sarah Williams", role: "Marketing", img: "https://images.unsplash.com/photo-1580489944761-15a19d654956?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80" }
            ].map((member, i) => (
      ...
      <section className="max-w-4xl mx-auto px-6 pb-16 text-center">
         <div className="bg-gradient-to-r from-teal-50 to-blue-50 rounded-2xl p-8 border border-gray-100">
            <h2 className="text-2xl font-bold text-slate-800 mb-3">Ready to start?</h2>
