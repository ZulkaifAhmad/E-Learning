...
import { Check, ChevronDown, ChevronLeft, ChevronRight, Smartphone, Apple } from 'lucide-react';
...
const MembershipPage = () => {
  ...
  const pricingPlans = [
    {
      ...
      price: "Free",
      period: "",
      features: ["Our content library", "Save your pending pages", "Access Teacher's notes"],
      active: false,
    },
    {
      name: "Individual",
      price: "$24",
      period: "/ month",
      features: ["Our content library", "Save your pending pages", "Access Teacher's notes", "Theme to 3 different styles", "Will help to overflow"],
    ...
    },
    {
      ...
      price: "$12",
      period: "/ editor",
      features: ["Our content library", "Save your pending pages", "Access Teacher's notes", "Theme to 3 different styles"],
      active: false,
    }
  ];
  ...
  return (
    <div className="font-sans text-slate-600 bg-white">
      ...
      {/* --- PRICING SECTION (RESTORED TO BIG) --- */}
      <section className="py-20 max-w-6xl mx-auto px-6">
        <div className="text-center mb-14">
          <h2 className="text-4xl font-bold text-teal-500 mb-3">Affordable pricing</h2>
          <p className="text-base text-gray-500">Choose the plan that suits you best</p>
        </div>

        {/* Increased gap and padding for "Big" look */}
        <div className="grid md:grid-cols-3 gap-10 items-center">
          {pricingPlans.map((plan, index) => (
            ...
            >
              ...
              <h3 className="text-sm font-bold text-teal-500 uppercase tracking-wider mb-5">{plan.name}</h3>
              {/* Big Text for Price */}
              ...
              <ul className="space-y-4 mb-10">
                {plan.features.map((feature, idx) => (
                  <li key={idx} className="flex items-center gap-3">
                    <div className={`p-1 rounded-full ${plan.active ? 'bg-orange-100' : 'bg-gray-100'}`}>
                       <Check size={16} className={plan.active ? 'text-orange-500' : 'text-gray-500'} />
                    </div>
              ...
              <button className={`w-full py-3.5 rounded-full text-base font-bold transition-colors ${
                plan.active 
                ...
                {plan.active ? 'Regular license' : index === 2 ? 'Extended license' : 'Try for free'}
              </button>
            </div>
          ))}
        </div>
      ...
      {/* --- REST OF WEBSITE (KEPT MEDIUM/CLEAN) --- */}
            ...
            <div key={index} className="border-b border-gray-100 pb-3">
              ...
              >
                <div className="flex items-center gap-3">
                   <div className={`w-2 h-2 rounded-full transition-colors ${openAccordion === index ? 'bg-teal-400' : 'bg-teal-100 group-hover:bg-teal-200'}`}></div>
      ...
      <section className="bg-blue-50 py-12 mb-16">
        <div className="max-w-5xl mx-auto px-6">
           <h2 className="text-2xl font-bold text-slate-800 mb-8">What our students have to say</h2>
           ...
           <div className="relative">
             ...
             <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                {testimonials.map((t, i) => (
                  <div key={i} className="bg-white p-6 rounded-xl shadow-sm hover:shadow-md transition-shadow text-center">
                    <img 
                      src={t.img} 
                      alt={t.name} 
                      className="w-16 h-16 rounded-full mx-auto mb-4 object-cover border-2 border-gray-50"
                    />
                    <h4 className="text-sm font-bold text-slate-800 mb-1">{t.name}</h4>
            ...
            <div className="flex flex-wrap gap-3">
               <button className="flex items-center gap-2 bg-[#29b2fe] hover:bg-sky-500 text-white px-5 py-2.5 rounded-lg transition-colors">
                  ...
                  <div className="text-left">
                     <div className="text-[9px] uppercase font-semibold opacity-80">Android APP on</div>
        ...
        <div className="grid md:grid-cols-2 gap-8">
           ...
           <div className="bg-white p-6 rounded-2xl shadow-md border border-gray-100 flex flex-col items-start">
              <div className="w-full h-48 rounded-xl overflow-hidden mb-5 bg-gray-200">
                <img src="https://images.unsplash.com/photo-1531482615713-2afd69097998?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80" alt="Teacher" className="w-full h-full object-cover" />
              </div>
              <h3 className="text-lg font-bold text-slate-800 mb-2">Become a Teacher</h3>
           ...
           <div className="bg-white p-6 rounded-2xl shadow-md border border-gray-100 flex flex-col items-start">
              <div className="w-full h-48 rounded-xl overflow-hidden mb-5 bg-gray-200">
                <img src="https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80" alt="Coursector" className="w-full h-full object-cover" />
              </div>
              <h3 className="text-lg font-bold text-slate-800 mb-2">Become a Coursector</h3>
              <p className="text-sm text-gray-500 mb-6 leading-relaxed">
                 Class, launched less than a year ago by Blackboard co-founder Michael Chasen, integrates exclusively...
              </p>
              <button className="w-full sm:w-auto bg-teal-400 text-white px-6 py-3 rounded-md text-sm font-semibold hover:bg-teal-500 transition-colors mt-auto">
