...
import {Code , Briefcase , TrendingUp , PenTool , Database , Shield , Globe , BarChart  } from "lucide-react";
  ...
  return (
    <div className="Courses">
      <div className="courses-head">
        ...
        <div className="lessons flex justify-between items-center">
          {lessons.map((lesson, index) => (
            <div
              key={index}
              className="lesson cursor-pointer flex flex-col gap-2 w-96  overflow-hidden bg-amber-200"
            >
              <img
      ...
      <div className="fav-courses">
        ...
        <div className="raper-fav-courses flex items-start justify-evenly gap-8 flex-wrap">
          ...
          <div key={index} className="fav-course min-h-50 flex justify-start items-center flex-col gap-2">
            <span>
              {item.logo}
            </span>
      ...
      <div className="start-learning flex justify-start items-center flex-col gap-5">
        ...
        <p className="w-2/3 text-base text-center">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempos Lorem ipsum dolor sitamet, consectetur adipiscing elit, sed do eiusmod tempor</p>
