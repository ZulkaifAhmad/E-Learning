    ...
    <div className="totc-container">
      <div className="totc-content">
        <h1 className="totc-title">
          <span className="circle-highlight">Everything</span> you can do in a
          physical classroom,{" "}
          <span className="text-teal">you can do with TOTC</span>
        </h1>

        <p className="totc-description">
          TOTC is school management software helps traditional and online
          schools manage scheduling, attendance, payments and virtual classrooms
          all in one secure cloud-based system.
        </p>

        <p className="totc-link underline text-sm">Learn more</p>
